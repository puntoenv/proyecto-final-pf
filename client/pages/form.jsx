...
function form() {
   ...
   const handenumber = (e)=> {
       ...
       number > 0 && number <=20? setpost({...post,[name]:value}) : console.log('error')
   }
  ...
  return (
    ...
    <form onSubmit={(evt) => handleSubmit(evt)}>
        ...
        <input type='text' name='name' placeholder='ingrese el nombre de tu mascota...' onChange={(e)=> handelselector(e)}  />
        <p></p>
    ...
    <p></p>
    <textarea type="text" name="description" placeholder='ingrese la descripcion de tu mascota...' onChange={(e)=> handelselector(e)} />
    <p></p>
    <input type="file" name="image" onChange={e => handelfiles(e) } multiple />
    <p></p>
    ...
    : post.name === '' ? <button>Name is require</button>
